...
public class Solution
{
    ...
    {
        for (Object tmp: apartaments)
        {
            if (tmp instanceof Apt1Room) ((Apt1Room) tmp).clean1Room();
            if (tmp instanceof Apt2Room) ((Apt2Room) tmp).clean2Rooms();
            if (tmp instanceof Apt3Room) ((Apt3Room) tmp).clean3Rooms();
        }
    }
