...
public class Solution {
    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            ...
            {
                while (!isInterrupted())
                {   if (step>=OnlineGame.steps.size()) OnlineGame.isWinnerFound=true;
                    else System.out.println(getName() + ":" + OnlineGame.steps.get(step));
            ...
            {
                if (step>=OnlineGame.steps.size()) System.out.println(getName() + ":победитель!");
